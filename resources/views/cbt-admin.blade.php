     ...
     <div class="font-jakarta"  @confirm-exit.window="pendingUrl = $event.detail.url; showConfirm = true">
          <header class="flex justify-between lg:mb-4 mb-2 relative">
               ...
               <div class="flex items-center gap-3 relative">
                    ...
                    <button x-on:click="isDirty = false" @click="isSaved = isSaving = true; showNotif = true; setTimeout(() => { showNotif = false; isSaving = false}, 3000)" :class="isSaving ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#00C482]'" class="bg-[#00C482] rounded-md lg:px-6 px-3 lg:py-3 py-1.5 cursor-pointer flex items-center gap-2">
