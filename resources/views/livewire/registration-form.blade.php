            ...
            <div class="relative h-fit w-fit mx-8 md:mx-12 lg:mx-auto">
                    ...
                    @if($currentStep == 1)
                        <div class=" py-6 px-8 md:py-12 md:px-10">
                            ...
                            <div class="mb-4 md:mb-8">
                                ...
                                <select wire:model="source_of_information" class="block w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="source_of_information" id="source_of_information">
                            ...
                            <div class="mb-4 md:mb-8">
                                ...
                                <select wire:model="is_first_competition" class="block w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="is_first_competition" id="is_first_competition">
                            ...
                            <div class="mb-4 md:mb-8">
                                ...
                                <select wire:model="reason" class="block w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="reason" id="reason">
                                    <option class="" value="">Pilih...</option>
                            ...
                            <div class="py-6 px-8 md:py-12 md:px-10">
                                ...
                                <div class="grid grid-cols-1 mb-12 w-full gap-4 md:grid-cols-2 md:gap-x-8 md:gap-y-4">                               
                                    <div class="md:grid md:col-span-2">
                                        ...
                                        <input wire:model="leader_name" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="leader_name" id="leader_name">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <input wire:model="leader_student_id" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="leader_student_id" id="leader_student_id">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <input wire:model="leader_date_of_birth" type="date" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="leader_date_of_birth" id="leader_date_of_birth">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <select wire:model="leader_gender" class="block w-full md:py-3 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="leader_gender" id="leader_gender">
                                            <option value="">Pilih...</option>
                                    ...
                                    <div class="md:grid md:col-span-2">
                                        ...
                                        <input wire:model="email" type="email" placeholder="Ketik di sini..." class="w-full md:w-full md:py-2 md:px-1 p-2 text-xs md:text-lg border mt-2 bg-gray-300 text-black" name="email" id="email">
                                ...
                                <div class="grid grid-cols-1 mb-12 w-full gap-4 md:grid-cols-2 md:gap-x-8 md:gap-y-4">                               
                                    <div class="md:grid md:col-span-2">
                                        ...
                                        <input wire:model="institution" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="institution" id="institution">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <input wire:model="institution_address" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="institution_address" id="institution_address">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <input wire:model="institution_province" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="institution_province" id="institution_province">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <input wire:model="institution_city" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="institution_city" id="institution_city">
                                    ...
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <input wire:model="parent_no_wa" type="text" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="parent_no_wa" id="parent_no_wa">
                                ...
                                <div class="mb-6 md:mb-12">
                                    ...
                                    <input wire:model="twibbon_links" class="md:w-2/3 w-full md:py-2 md:px-1 p-2 border mt-2 bg-gray-300 text-black text-xs md:text-lg" placeholder="Ketik disini..." type="text" name="twibbon_links" id="twibbon_links">
                                    @error('twibbon_links') <span class="text-red-500 text-xs block">{{ $message }}</span> @enderror
                                </div>
                                {{-- check-box --}}
                                <div class="flex items-center gap-2 md:gap-4">
                                    <input wire:model="terms_accepted" class="size-6" type="checkbox" name="terms_accepted" id="terms_accepted">
                                ...
                                <div class="grid grid-cols-1 mb-12 w-full gap-6 md:grid-cols-2 md:gap-x-8 md:gap-y-4">
                                    <div class="w-full grid gap-4">
                                        ...
                                        <div class="flex flex-col justify-between">
                                            ...
                                            <input type="text" wire:model="member1_name" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="member1_name" id="member1_name">
                                        ...
                                        <div class="flex flex-col justify-between">
                                            ...
                                            <input type="text" wire:model="member1_student_id" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="member1_student_id" id="member1_student_id">
                                        ...
                                        <div class="flex flex-col justify-between">
                                            ...
                                            <select wire:model="member1_gender" class="block w-full md:py-3 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="member1_gender" id="member1_gender">
                                                <option value="">Pilih...</option>
                                        ...
                                        <div class="flex flex-col justify-between">
                                            ...
                                            <input type="date" wire:model="member1_date_of_birth" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="member1_date_of_birth" id="member1_date_of_birth">
                                        ...
                                        <div class="flex flex-col justify-between">
                                            ...
                                            <input type="text" wire:model="member1_email" placeholder="Ketik di sini..." class="w-full md:py-2 md:px-1 p-2 border mt-2 text-xs md:text-lg bg-gray-300 text-black" name="member1_email" id="member1_email">
                        ...
                        <div class="py-5 px-6 md:py-9 md:px-10">
                            ...
                            <div class="mb-4 md:mb-8">
                                ...
                                <div class="flex gap-x-1 md:gap-x-4 items-end">
                                    ...
                                    <button wire:click="applyCoupon" type="button" class="border border-[#12B1EB] rounded-md py-2 px-3 md:text-lg text-xs md:py-2 md:px-5 bg-[#12B1EB] text-white text-center">Masukkan</button>
                                </div>
                            ...
                            <div class="mb-4 md:mb-8">
                                ...
                                <input wire:model="transaction_proof" class="w-full md:py-2 md:px-1 p-1 border md:mt-2 mt-1 text-xs md:text-lg bg-gray-300" type="file" name="transaction_proof" id="transaction_proof">
                ...
                <div class="py-14 grid grid-cols-3 items-center">
                    ...
                    @if($currentStep > 1 && $currentStep < 4)
                        <div class="w-20 h-8 md:w-38 md:h-12 bg-gradient-to-r from-[#12B1EB] via-white to-[#FFD900] p-[1px] grid justify-self-start cursor-pointer" wire:click="back({{ $currentStep - 1 }})">
                        ...
                        <div class="w-25 h-8 md:w-30 md:h-12 bg-gradient-to-r from-[#12B1EB] via-white to-[#FFD900] rounded-full p-[1px]">
                            <div class="w-full h-full bg-black rounded-full flex items-center justify-center">
                                <div class="flex items-center">
                                    <div class="relative w-2 h-2 md:w-3 md:h-3 rounded-full flex items-center justify-center 
                                        {{ $currentStep >= 1 ? 'bg-white' : 'bg-white' }}">
                                        @if($currentStep == 1)
                                    ...
                                    <div class="relative w-2 h-2 md:w-3 md:h-3 rounded-full flex items-center justify-center 
                                        {{ $currentStep >= 2 ? 'bg-white' : 'bg-white' }}">
                                        @if($currentStep == 2)
                                            <div class="w-1.5 h-1.5 md:w-2.5 md:h-2.5 bg-black rounded-full"></div>
                                        @endif
                                    </div>
                                    <div class="h-[0.5px] w-2 md:w-3 bg-white"></div>
                                    <div class="relative w-2 h-2 md:w-3 md:h-3 rounded-full flex items-center justify-center 
                                        {{ $currentStep >= 3 ? 'bg-white' : 'bg-white' }}">
                                        @if($currentStep == 3)
                                            <div class="w-1.5 h-1.5 md:w-2.5 md:h-2.5 bg-black rounded-full"></div>
                                        @endif
                                    </div>
                                    <div class="h-[0.5px] w-2 md:w-3 bg-white"></div>
                                    <div class="relative w-2 h-2 md:w-3 md:h-3 rounded-full flex items-center justify-center 
                                        {{ $currentStep >= 4 ? 'bg-white' : 'bg-white' }}">
                                        @if($currentStep == 4)
                                            <div class="w-1.5 h-1.5 md:w-2.5 md:h-2.5 bg-black rounded-full"></div>
                                        @endif
                                    </div>
                    ...
                    {{-- Next/Submit Button --}}
                    @if($currentStep < 3)
                        <div class="w-20 h-8 md:w-38 md:h-12 bg-gradient-to-r from-[#12B1EB] via-white to-[#FFD900] p-[1px] grid justify-self-end cursor-pointer" 
                            wire:click="{{ $currentStep == 1 ? 'firstStepSubmit' : 'secondStepSubmit' }}">
                            <div class="w-full h-full bg-black flex items-center justify-center">
                                <div class="flex justify-between item-center gap-2">
                    ...
                    @elseif($currentStep == 3)
                        <div class="w-20 h-8 md:w-38 md:h-12 bg-gradient-to-r from-[#12B1EB] via-white to-[#FFD900] p-[1px] grid justify-self-end cursor-pointer" wire:click="submitForm">
                            <div class="w-full h-full bg-black flex items-center justify-center">
                                <div class="flex justify-between item-center gap-2">
