<div class="text-center mt-5 mx-6 grid grid-flow-col grid-rows-2 gap-5 md:block">
    <x-nav-link x-bind:class="isOpen ? 'pl-5' : 'pl-5 md:pl-0 md:justify-center'" id="icon" href="/competitions"
        :active="request()->is('competitions')">
    ...
    <x-nav-link x-bind:class="isOpen ? 'pl-5' : 'pl-5 md:pl-0 md:justify-center'" id="icon" href="/profil"
    ...
    <x-nav-link x-bind:class="isOpen ? 'pl-5' : 'pl-5 md:pl-0 md:justify-center'" id="icon" href="/informasi"
