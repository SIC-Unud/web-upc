...
<body>
   ...
   @endphp
   <div class="bg-black flex justify-between relative overflow-hidden">
      <img src="/assets/Logolayout.png" alt="" class="w-11 ml-3 py-4 md:w-28 md:pl-[30px] md:py-[19px]">
      <img src="/assets/garis3.png" alt="" class="w-[15px] mr-3 py-4 md:w-18 md:py-[19px] md:pr-[30px]">
      <div
   ...
   <div class="bg-[url(../../public/assets/latar2.png)] bg-black bg-cover">
      ...
      <div class="mt-12 mx-8 md:mt-20">
         <div class="relative mx-auto lg:w-fit">
            <h1 class="text-[18px] md:text-2xl pb-4 md:px-70 md:pb-10 text-white text-center">BIDANG LOMBA</h1>
            <div
      ...
      <div class="text-white px-10 mt-15 md:mt-30 md:px-32">
         <h1 class="text-lg md:text-2xl pb-4 md:px-70 md:pb-10 text-white text-center">TIMELINE</h1>
         <div class="grid grid-cols-3">
            ...
            <div class="col-span-3">
               <div class="flex items-center justify-center gap-6 w-fit mx-auto translate-x-[calc(50%-12px)]">
                  <img src="/assets/star.png" alt="" class="size-6">
                  <div class="">
                     <h3 class="font-medium text-xs text-wrap break-words whitespace-normal md:text-lg">Puncak Acara
                        (Semi Final & Final)</h3>
      ...
      <div class="flex items-center mr-10 mt-12 md:mr-35 md:mt-43">
         ...
         <div
            ...
            <div class="flex">
               ...
               <div class="text-white">
                  <h1 class="text-[7px] md:text-2xl font-koulen">Putu Devika Raisa Nayuri</h1>
                  <h2 class="text-[6px] md:text-xl font-koulen">SD Jambe Agung Batubulan</h2>
                  <p class="font-lao text-[6px] md:text-lg">Kegiatan ini sangat disarankan. Untuk memberikan
                     wadah
