...
<body>
   ...
   <div class="flex font-jakarta">
      {{-- Side Bar --}}
      <nav id="sidebar"
         class="bg-white transition-all duration-300 min-h-screen z-50 top-0 left-0 bottom-0 shadow-[0_0_30px_rgba(0,0,0,0.25)] w-50 fixed lg:w-60">
         ...
         <div class="text-center mx-2 py-5 border-b">
            ...
            <h1 class="sidebar-text text-wrap mb-[2px] text-[10px] lg:text-base">YUDHISTIRA ARIMBAWA SAPUTRA</h1>
            <h1 class="sidebar-text text-[8px] lg:text-sm">Kompetisi Astronomi</h1>
         </div>
         @if ($isAdmin)
      ...
      <main id="main" class="w-full min-h-screen transition-all duration-300 lg:ml-60">
         {{-- Nav Bar --}}
         ...
         <footer id="mainFooter"
            class="transition-all max-h-fit min-h-fit duration-300 fixed z-40 bg-white bottom-0 right-0 left-0 lg:ml-60">
