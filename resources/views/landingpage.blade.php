    ...
    <div class="bg-[url(../../public/assets/latar2.png)] bg-black bg-cover">
        ...
        <div class="relative text-white px-10 mt-15 md:mt-30 md:px-32" id="timeline">
            <div class="relative">
                ...
                <h1 class="text-lg md:text-3xl pb-4 md:px-70 md:pb-10 text-white text-center font-novaria">TIMELINE
                </h1>
            </div>
                ...
                @foreach ($timeline as $item)
                    @if ($loop->first)
                        ...
                        <div class="col-span-3">
                            <div
                                class="flex items-center justify-center gap-6 w-fit mx-auto -translate-x-[calc(50%-12px)]">
                                <div>
