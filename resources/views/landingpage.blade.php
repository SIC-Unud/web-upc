...
<body>
   ...
   <div class="bg-[url(../../public/assets/image-9.png)] bg-black bg-cover">
      <div class="flex items-center justify-center">
         <img class="hidden md:block" src="/assets/PurpleCat.png" alt="">
         <div class="mt-[39px]">
            <h1 class="text-white text-[13px] md:text-3xl md:mb-7 text-center md:flex md:justify-center font-julius">
   ...
   <div class="bg-[url(../../public/assets/latar2.png)] bg-black bg-cover">
      <div class="pt-7 px-4 md:px-18 md:pt-[57px] overflow-x-auto">
         <div class="flex gap-2 md:gap-[29px] w-fit md:w-auto snap-x">
            <div
               ...
               <img class="object-contain md:object-none" src="/assets/foto1.png" alt="">
            </div>
            <div
               class="drop-shadow-white/25 drop-shadow-[10px_9px_9px] py-6 snap-center w-[84px] md:w-[269px] shrink-0 lg:shrink">
               <img class="object-contain md:object-none" src="/assets/foto2.png" alt="">
            </div>
            <div
               class="drop-shadow-white/25 drop-shadow-[10px_9px_9px] py-6 snap-center w-[84px] md:w-[269px] shrink-0 lg:shrink">
               <img class="object-contain md:object-none" src="/assets/foto3.png" alt="">
            </div>
            <div
               class="drop-shadow-white/25 drop-shadow-[10px_9px_9px] py-6 snap-center w-[84px] md:w-[269px] shrink-0 lg:shrink">
               <img class="object-contain md:object-none" src="/assets/foto4.png" alt="">
            </div>
            <div
               class="drop-shadow-white/25 drop-shadow-[10px_9px_9px] py-6 snap-center w-[84px] md:w-[269px] shrink-0 lg:shrink">
               <img class="object-contain md:object-none" src="/assets/foto5.png" alt="">
            </div>
            <div
               class="drop-shadow-white/25 drop-shadow-[10px_9px_9px] py-6 snap-center w-[84px] md:w-[269px] shrink-0 lg:shrink">
               <img class="object-contain md:object-none" src="/assets/foto6.png" alt="">
            </div>
         </div>
      </div>
      ...
      <div class="flex items-center ml-10 mt-12 md:ml-35 md:mt-65">
         <div class="w-[962px]">
            ...
            <h1 class="text-white text-justify text-[8px] md:text-2xl font-lao mt-4 md:mt-10">Udayana Physics
               ...
               yang diselenggarakan oleh Himpunan Mahasiswa Fisika (HIMAFI), Fakultas Matematika dan Ilmu Pengetahuan
               Alam,
               Universitas Udayana. Kegiatan ini merupakan ajang kompetisi dan perlombaan berskala nasional yang secara
               konsisten menarik partisipasi dari pelajar hingga mahasiswa dari berbagai daerah di Indonesia. Tahun ini,
               UPC menyelenggarakan
               beberapa cabang lomba meliputi: Cerdas Cermat SD (untuk siswa SD se-Bali), Kompetisi Fisika SMP (untuk
               siswa
         ...
         <div
            ...
            <div class="flex border-b border-white mb-2 pb-2 md:pb-8 md:mb-9">
               ...
               <div class="text-white">
                  ...
                  <p class="font-lao text-[6px] md:text-3xl">Bagi saya, UPC ini merupakan sarana yang sangat baik
                     sebagai persiapan awal hingga menengah peserta didik dalam mengerjakan soal-soal olimpiade yang
            ...
            <div class="flex">
               ...
               <div class="text-white">
                  ...
                  <p class="font-lao text-[6px] md:text-3xl">Kegiatan ini sangat disarankan. Untuk memberikan wadah
      ...
      <div class="mt-18 md:mt-38">
         <div class="relative w-fit mx-auto">
            <h1 class="text-[18px] md:text-[50px] pb-1 px-3 md:px-67 md:pb-13 text-white text-center">MEDIA PARTNER</h1>
            <div
               class="h-0.5 bg-gradient-to-r absolute bottom-0 left-0 from-black via-[#12B1EB]/95 to-white from-0% via-20% to-60% w-1/2">
            </div>
            <div
         ...
         <div class="mt-4 pb-5 text-center text-[8px] md:text-4xl md:mt-[97px] md:mx-auto font-koulen md:pb-14 text-white/20">
