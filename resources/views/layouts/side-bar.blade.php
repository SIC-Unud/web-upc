      ...
      <nav id="sidebar" x-bind:class="isOpen ? 'lg:w-60 w-50' : 'w-30'"
         ...
         <div class="text-center mx-2 py-5 border-b">
            <div class="text-center mx-2 py-5 border-b">
               ...
               <h1 x-show="isOpen" class="sidebar-text text-wrap mb-[2px] text-[10px] lg:text-base">{{ auth()->user()->role ? "Admin UPC" : auth()->user()->participant->leader_name }}</h1>
            ...
            <nav x-show="isOpen" x-transition.delay.50ms
                ...
                <div :class="isOpen? 'top-9' : '-top-100' " x-transition.duration.300ms
                    ...
                    <div class="flex gap-4 items-center m-5">
                        ...
                        <div>
                            <h1 class="sidebar-text text-wrap mb-[2px] text-sm">{{ auth()->user()->role ? "Admin UPC" : auth()->user()->participant->leader_name }}</h1>
                            <h1 class="sidebar-text text-sm">{{ auth()->user()->role ? 'Administrator' : auth()->user()->participant->competition->name }}</h1>
                        </div>
                    </div>
